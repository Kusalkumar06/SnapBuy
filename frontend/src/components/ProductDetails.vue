<template>
  <div class="px-4 lg:px-30 py-10 dark:text-gray-200">
      ...
      <div class="flex-1 flex flex-col justify-center px-4 py-2">
        <div class="flex flex-col items-start justify-evenly h-full w-full">
          ...
          <div class="flex flex-wrap lg:flex-nowrap gap-4 mt-4">
            <div v-if="cartStore.getItemById(productDetails._id)" class="flex items-center gap-3">
    ...
    <div class="flex flex-col lg:flex-row gap-5 shrink">
      <div class="w-full lg:w-[40%] border-b lg:border-b-0 lg:border-r pb-8 lg:pb-0 dark:border-gray-700">
