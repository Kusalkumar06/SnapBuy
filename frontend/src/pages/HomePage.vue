...
<template>
  ...
  <div>
  <div class="relative mt-[100vh] bg-gray-100 dark:bg-black">
    <div class="container mx-auto py-16 px-8">
      <h2 class="text-3xl font-medium mb-8 text-black dark:text-white">Explore our Products</h2>
      <section v-for="category in productStore.categories" :key="category" class=" sticky top-18  bg-white/95 dark:bg-gray-900/95 p-6 my-6 rounded-lg shadow-lg" >
        <div class="mb-6">
